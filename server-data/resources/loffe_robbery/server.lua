...
AddEventHandler('loffe_robbery:rob', function(store)
    ...
    TriggerEvent('pixelatedPoliceAlerts:sendAlert', 'money-bill', '10-17:'..Config.Stores[store].name..' Robbery', 'A silent alarm was triggered at the location and it\'s currently being robbed.')
