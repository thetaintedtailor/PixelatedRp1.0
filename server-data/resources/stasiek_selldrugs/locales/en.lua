Locales ['en'] = {
	...
	['weed_pooch'] = ' pouch of ~g~weed~s~ for~r~ ',
	['meth_pooch'] = ' pouch of ~g~meth~s~ for~r~ ',
	['coke_pooch'] = ' pouch of ~g~coke~s~ for~r~ ',
	['opium_pooch'] = ' pouch of ~g~opium~s~ for~r~ ',
	['weed'] = ' ~g~weed~s~ for~r~ ',
	['meth'] = ' ~g~meth~s~ for~r~ ',
	['coke'] = ' ~g~coke~s~ for~r~ ',
