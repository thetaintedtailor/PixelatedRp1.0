...
-- Declarations for vars used in the update
local direction, pos, var1, var2, currentZone, streetName, crossStreetName
...
Citizen.CreateThread(function()
	while true do
        Citizen.Wait(500)
            ...
            crossStreetName = GetStreetNameFromHashKey(var2)
