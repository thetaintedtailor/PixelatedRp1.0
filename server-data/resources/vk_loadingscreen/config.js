...
VK.music.url = "music/pixies_hey.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Hey - The Pixies"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "suggested by Cybil (IGN: Connor Carver)"; // Music submited by... ("NONE" to desactive)
