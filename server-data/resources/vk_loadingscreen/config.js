...
VK.music.url = "music/talk_street.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Greta Van Fleet - Talk On The Street"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "Requested by Barlow"; // Music submited by... ("NONE" to desactive)
