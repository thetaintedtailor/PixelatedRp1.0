...
VK.music.url = "music/wasnt_looking.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Eliza - Wasn´t Looking"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "Requested by Kat"; // Music submited by... ("NONE" to desactive)
