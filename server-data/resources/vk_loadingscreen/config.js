...
VK.music.url = "music/subfocus_lastjungle.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Last Jungle - Sub Focus"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "suggested by Ecktos (IGN: Sebastian West)"; // Music submited by... ("NONE" to desactive)
