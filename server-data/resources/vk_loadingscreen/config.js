...
VK.music.url = "music/STORMZY.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Vossi Bop - Stormzy"; // Music title ("NONE" to desactive)
