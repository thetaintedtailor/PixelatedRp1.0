...
VK.music.url = "music/melancholia.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "- - -"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "A song for Mr. Myles..."; // Music submited by... ("NONE" to desactive)
