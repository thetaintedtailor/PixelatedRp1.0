...
VK.music.url = "music/CarsonHayes_Miami.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Carson Hayes & SaneBeats - Miami"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "suggested by A-101 Chief Bender"; // Music submited by... ("NONE" to desactive)
