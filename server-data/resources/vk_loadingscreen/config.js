...
VK.music.url = "music/thetruth-wincantlose.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Win Can't Lose - The Truth"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "suggested by Mr_Double_D (Richard Cox)"; // Music submited by... ("NONE" to desactive)
