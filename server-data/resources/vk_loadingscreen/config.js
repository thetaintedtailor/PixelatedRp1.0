...
VK.music.url = "music/cakin.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Cakin' - Yogi, DRAM, Lady Leshurr"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "suggested by phy (IGN: Horace Zilinski)"; // Music submited by... ("NONE" to desactive)
