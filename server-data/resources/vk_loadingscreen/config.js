...
VK.music.url = "music/what_you_promised_fairlane.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "What You Promised - Fairlane & Zack Gray"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "suggested by Ellethwen (IGN: Evie Quinn)"; // Music submited by... ("NONE" to desactive)
