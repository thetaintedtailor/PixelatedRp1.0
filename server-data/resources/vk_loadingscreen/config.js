...
VK.music.url = "music/dixieland_delight.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Dixieland Delight - Alabama"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "Suggested by Detective S.Arceneaux"; // Music submited by... ("NONE" to desactive)
