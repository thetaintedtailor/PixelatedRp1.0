...
VK.music.url = "music/look_back_at_it_boogie.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "A Boogie Wit Da Hoodie - Look Back At It"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "Song requested by Mightfull (IGN: Stefan Nobel)"; // Music submited by... ("NONE" to desactive)
