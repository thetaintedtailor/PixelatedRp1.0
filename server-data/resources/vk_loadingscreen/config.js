...
VK.music.url = "music/battle_hymn.mp3"; // Music url, can be on local or distant (http://....) ("NONE" to desactive music)
VK.music.title = "Battle Hymn - Vinnie Paz"; // Music title ("NONE" to desactive)
VK.music.submitedBy = "Suggested by Mightfull (IGN: Stefan Nobel)"; // Music submited by... ("NONE" to desactive)
