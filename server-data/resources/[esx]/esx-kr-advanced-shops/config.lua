...
Config.Items = {
    ...
    [5] = {label = "Drill",       item = "drill",        price = 4000},
    ...
    [10] = {label = "Repair Kit",       item = "repairkit",        price = 500},
    [11] = {label = "Red Rose",       item = "rose",        price = 5},
    [12] = {label = "Sandwich",       item = "sandwich",        price = 5},
    [13] = {label = "Scratchoff Ticket",       item = "scratchoff",        price = 5},
}
...
Config.Images = {
  ...
  [8] = {item = "oxygen_mask",   src = "img/oxygen_mask.png"},
  [9] = {item = "picnic",   src = "img/picnic.png"},
  [10] = {item = "redgull",   src = "img/redgull.png"},
  [11] = {item = "repairkit",   src = "img/repairkit.png"},
  [12] = {item = "rose",   src = "img/rose.png"},
  [13] = {item = "sandwich",   src = "img/sandwich.png"},
  [14] = {item = "scratchoff",   src = "img/scratchoff.png"},
  [15] = {item = "weed",   src = "img/weed.png"},
  [16] = {item = "bandage",   src = "img/bandage.png"},
}
