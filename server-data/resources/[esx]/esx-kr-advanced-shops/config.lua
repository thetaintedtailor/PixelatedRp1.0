...
Config.Locale = 'en'
Config.DeliveryTime = 15 -- IN SECOUNDS DEFAULT (18000) IS 5 HOURS / 300 MINUTES
...
Config.Items = {
    ...
    [3] = {label = "Ammunition Clip",       item = "clip",        price = 50},
    [4] = {label = "Donut",       item = "donut",        price = 4},
    [5] = {label = "Drill",       item = "drill",        price = 2500},
    [6] = {label = "Lockpick",       item = "lockpick",        price = 25},
    [7] = {label = "Oxygen Mask",       item = "oxygen_mask",        price = 500},
    [8] = {label = "Picnic Basket",       item = "picnic",        price = 5},
    [9] = {label = "Redgull",       item = "redgull",        price = 5},
...
Config.Images = {
  ...
  [5] = {item = "drill",   src = "img/drill.png"},
  [6] = {item = "lockpick",   src = "img/lockpick.png"},
  [7] = {item = "oxygen_mask",   src = "img/oxygen_mask.png"},
  [8] = {item = "picnic",   src = "img/picnic.png"},
  [9] = {item = "redgull",   src = "img/redgull.png"},
  [10] = {item = "repairkit",   src = "img/repairkit.png"},
  [11] = {item = "rose",   src = "img/rose.png"},
  [12] = {item = "sandwich",   src = "img/sandwich.png"},
...
Config.Zones = {
  ...
  Shop21 = {
    Pos = {x = 1787.07,  y = 2486.43, z = 122.70, number = 84.42}
  },
  Robbery1 = {
