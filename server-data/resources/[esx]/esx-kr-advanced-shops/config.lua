...
Config.Items = {
    ...
    [8] = {label = "Oxygen Mask",       item = "oxygen_mask",        price = 500},
    [9] = {label = "Picnic Basket",       item = "picnic",        price = 5},
    [10] = {label = "Redgull",       item = "redgull",        price = 5},
    [11] = {label = "Repair Kit",       item = "repairkit",        price = 500},
    [12] = {label = "Red Rose",       item = "rose",        price = 5},
    [13] = {label = "Sandwich",       item = "sandwich",        price = 5},
    [14] = {label = "Scratchoff Ticket",       item = "scratchoff",        price = 5},
}
...
Config.Images = {
  ...
  [15] = {item = "water",   src = "img/water.png"},
  [16] = {item = "weed",   src = "img/weed.png"},
  [17] = {item = "bandage",   src = "img/bandage.png"},
}
