...
function createForSaleBlips()
	if showblip then
		...
		IDBLIPS = {
			...
			[21] = {x = 1787.07,  y = 2486.43, z = -123.70, n = 21},
		}
...
function Robbery(id)
    ...
    [7] = {x = 2674.36, y = 3288.0, z = 48.24, heading = 339.44},
    [9] = {x = 1160.77, y = -314.03, z = 69.50, heading = 10.81},
    [10] = {x = -708.14, y = -904.05, z =19.25 , heading = 5.29}, 
    [11] = {x = -1828.23, y = 799.83, z = 138.15, heading = 53.63}, 
    [12] = {x = 1706.87, y = 4919.76, z = 42.10, heading = 237.41}, 
    [13] = {x = 1960.75, y = 3748.67, z = 32.34, heading = 304.34}, 
    [14] = {x = 1126.26, y = -980.84, z = 45.42, heading = 9.13}, 
    [15] = {x = 30.45, y = -1339.88, z = 29.5 , heading = 269.79}, 
    [16] = {x = -1383.59, y = -630.25, z = 30.82, heading = 213.19}, 
    ...
    [20] = {x = 1736.66, y = 6419.02, z = 35.11, heading = 247.6},
}
        ...
        Wait(0)
			local playerpos = GetEntityCoords(GetPlayerPed(-1))
				if OnRobbery and GetDistanceBetweenCoords(playerpos.x, playerpos.y, playerpos.z, Coordss.x, Coordss.y, Coordss.z, true) <= 15 then
					...
					TriggerEvent("mt:missiontext", "Break the vault:~r~ " .. hp/10 .. "%", 1000)
