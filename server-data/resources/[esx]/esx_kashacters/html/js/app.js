        ...
        if(data.characters !== null) {
            $.each(data.characters, function (index, char) {
                if (char.charid !== 0) {
                    ...
                    $('[data-charid=' + charid + ']').html('<h3 class="character-fullname">'+ char.firstname +' '+ char.lastname +'</h3><div class="character-info"><p class="character-info-work"><strong>Job: </strong><span>'+ char.job +'</span></p><p class="character-info-money"><strong>Cash: </strong><span>'+ char.money + '$' +'</span></p><p class="character-info-bank"><strong>Bank: </strong><span>'+ char.bank + '$' +'</span></p> <p class="character-info-dateofbirth"><strong>Date of Birth: </strong><span>'+ char.dateofbirth +'</span></p> <p class="character-info-gender"><strong>Gender: </strong><span>'+ char.sex +'</span></p> <p class="character-info-height"><strong>Height: </strong><span>'+ char.height + 'cm' +'</span></p> <p class="character-info-phone-number"><strong>Phone Number: </strong><span>'+ char.phone_number   +'</span></p>').attr("data-ischar", "true");
                }
            });
        }
    };
