...
Config.Blips = {
	...
	CokeProcessing ={x=1100.4555664063, y=-3194.232421875, z=-40.20,	name = 'Coke Processing'},
	CokeDealer ={x=1691.02, y=3286.67,  z=40.15,	name = 'coke_dealer'},
	MethField =	{x=1005.529296875, 	 y=-3200.3464355469,  z=-39.99,	name = 'Meth Field'},
	MethProcessing = {x=1011.0367431641, y=-3195.7021484375,  z=-39.99,	name = 'Meth Processing'},
	MethDealer = {x=-1639.08, y=-1062.88, z=12.15,	name = 'Meth Dealer'},
	WeedField =	{x=1060.1691894531, y=-3196.9636230469,  z=-40.153,	name = 'Weed Field'},
	WeedField2 = {x=1060.6087646484, y=-3202.9436035156,  z=-40.153,	name = 'Weed Field'},
	WeedProcessing = {x=1039.2406005859,  y=-3205.3784179688,  z=-39.12,	name = 'Weed Processing'},
	WeedDealer = {x=-1154.43, y=-1520.99, z=09.63,	name = 'Weed Dealer'},
	OpiumField = { x=1341.43,	y=4389.84,  z=43.34,	name = 'Opium Field'},
	OpiumProcessing = {x=1337.76, y=4386.05,  z=43.39,	name = 'Opium Processing'},
	OpiumDealer = {x=-1892.33,y=2076.78,z=140.0,	name = 'Opium Dealer'},
}
