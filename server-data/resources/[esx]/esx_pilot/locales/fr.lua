Locales['fr'] = {
  ...
  ['spawn_plane'] = 'sortir hélicoptère',
  ...
  ['return_to_veh'] = 'veuillez remonter dans votre hélicoptère pour continuer la mission',
  ['only_pilot'] = "vous ne pouvez ranger que les hélicoptères de l'aéroport",
  ['must_in_pilot'] = "vous devez être dans un hélicoptère de l'aéroport pour commencer la mission",
  ['must_in_vehicle'] = 'vous devez être dans un hélicoptère pour commencer la mission',
