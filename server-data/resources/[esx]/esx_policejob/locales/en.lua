Locales['en'] = {
  ...
  ['garage_has_stored_all'] = 'All vehicles have been stored.',
  ['garage_has_notstored'] = 'no nearby owned vehicles were found',
  ['garage_has_notstored_all'] = 'no owned vehicles were found',
  ['garage_recoverimpound'] = 'Recover all vehicles from impound',
  ['garage_has_recovered_all'] = 'Vehicles have returned from impound.',
  ['garage_has_not_recovered_all'] = 'You have no impounded vehicles.',
  ...
  ['garage_storeallitems'] = 'store all vehicles in the garage',
  ...
  ['confiscate_cash'] = 'confiscate cash: <span style="color:red;">$%s</span>',
