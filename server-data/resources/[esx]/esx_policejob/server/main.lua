...
AddEventHandler('esx_policejob:putInVehicle', function(target)
	...
	if xPlayer.job.name == 'police' then
		...
		TriggerClientEvent('seatbelt:enableSeatbelt', target)
	else
...
AddEventHandler('esx_policejob:OutVehicle', function(target)
	...
	if xPlayer.job.name == 'police' then
		...
		TriggerClientEvent('seatbelt:disableSeatbelt', target)
	else
...
AddEventHandler('esx_policejob:addLicense', function(target, type, label, cb)
	TriggerEvent('esx_license:addLicense', target, type, function()
		TriggerClientEvent('esx:showNotification', target, 'You have been granted a ~g~' .. label)
	end)
end)