...
files {
  ...
  'html/img/items/WEAPON_WEAPON_SNSPISTOL.png',
  'html/img/items/WEAPON_WEAPON_HEAVYPISTOL.png',
  'html/img/items/WEAPON_WEAPON_VINTAGEPISTOL.png',
  'html/img/items/WEAPON_WEAPON_BULLPUPSHOTGUN.png',
