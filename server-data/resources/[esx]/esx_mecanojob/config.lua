...
Config.Zones = {
	...
	MecanoActions = {
			Pos   = { x = -197.14999389648, y = -1318.67468261, z = 30.089344 }, { x = 1187.11, y = 2636.39, z = 37.40 }, { x = -341.82, y = -132.20, z = 38.01 }, { x = 725.52, y = -1073.68, z = 27.31 },
	...
	VehicleSpawnPoint = {
			Pos   = {x = -210.89, y = -1304.43, z = 30.29}, {x = 1171.57, y = 2656.94, z = 37.08}, {x = -371.32, y = -111.85, z = 37.68}, {x = 711.20, y = -1071.66, z = 21.33},
			Size  = { x = 3.0, y = 3.0, z = 3.0 },
			Type  = -1,
		},

	VehicleDeleter = {
			Pos   = { x = -199.82, y = -1306.86, z = 30.28 }, {x = 1171.57, y = 2656.94, z = 37.08}, {x = -371.32, y = -111.85, z = 37.68}, {x = 711.20, y = -1071.66, z = 21.33},
			Color = { r = 204, g = 204, b = 0 },
	...
	VehicleDelivery = {
			Pos   = { x = -222.22, y = -1329.97, z = 29.89}, {x = 1171.57, y = 2656.94, z = 37.08}, {x = -371.32, y = -106.34, z = 37.68}, {x = 711.20, y = -1071.66, z = 21.33},
