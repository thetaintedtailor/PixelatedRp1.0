...
Config.Zones = {
	...
	MecanoActions = {
			...
			Pos   = { x = 1187.11, y = 2636.39, z = 37.40 },
			Pos   = { x = -341.82, y = -132.20, z = 38.01 },
			Pos   = { x = 725.52, y = -1073.68, z = 28.31 },
	...
	VehicleSpawnPoint = {
			...
			Pos   = {x = 1171.57, y = 2656.94, z = 37.08},
			Pos   = {x = -371.32, y = -111.85, z = 37.68},
			Pos   = {x = 714.40, y = -1071.89, z = 21.28},
