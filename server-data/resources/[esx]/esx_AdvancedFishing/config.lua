Config = {}
	...
	Config.FishPrice = {a = 20, b = 25} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 35, b = 40} --Will get dirty money
	Config.SharkPrice = {a = 55, b = 60} --Will get dirty money
